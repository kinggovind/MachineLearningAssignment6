...
# If we intend to measure the similarity of any two samples using a quadratic form, such as the dot-product or another kernel, this technique can be helpful.
